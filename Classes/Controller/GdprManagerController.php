...
use GdprExtensionsCom\GdprExtensionsComGrthreec\Domain\Model\MapLocation;
...
class GdprManagerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    public function listAction(): \Psr\Http\Message\ResponseInterface
    {
        ...
        $threeColumnGridData = $this->gdprManagerRepository->findByExtension_key('gdpr_extensions_com_grthreec')->toArray();
        return $this->redirect('edit',null,null,['gdprManager' => $threeColumnGridData[0]]);
     ...
     * action show
     *
     * @param \GdprExtensionsCom\GdprExtensionsComGrthreec\Domain\Model\GdprManager $gdprManager
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function showAction(\GdprExtensionsCom\GdprExtensionsComGrthreec\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
     ...
     * action create
     *
     * @param \GdprExtensionsCom\GdprExtensionsComGrthreec\Domain\Model\GdprManager $newGdprManager
     */
    public function createAction(\GdprExtensionsCom\GdprExtensionsComGrthreec\Domain\Model\GdprManager $newGdprManager)
    {
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function editAction(\GdprExtensionsCom\GdprExtensionsComGrthreec\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {   
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function updateAction(\GdprExtensionsCom\GdprExtensionsComGrthreec\Domain\Model\GdprManager $gdprManager) : \Psr\Http\Message\ResponseInterface
    {
        if($this->request->hasArgument('tx_GdprExtensionsComGrthreec_web_GdprExtensionsComGrthreecgdprmanager')){
            $locationsData = $this->request->getArgument('tx_GdprExtensionsComGrthreec_web_GdprExtensionsComGrthreecgdprmanager')['locations'];
        }
     ...
     * @param \GdprExtensionsCom\GdprExtensionsComGrthreec\Domain\Model\GdprManager $gdprManager
     */
    public function deleteAction(\GdprExtensionsCom\GdprExtensionsComGrthreec\Domain\Model\GdprManager $gdprManager)
    {
