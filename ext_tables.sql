...
CREATE TABLE tt_content (
	gdpr_color_of_text_threecgd varchar(255) NOT NULL DEFAULT '',
	gdpr_button_text_color_threecgd varchar(255) NOT NULL DEFAULT '',
	gdpr_button_color_threecgd varchar(255) NOT NULL DEFAULT '',
	gdpr_button_shape_threecgd int(11) NOT NULL DEFAULT 1,
	gdpr_background_color_threecgd varchar(255) NOT NULL DEFAULT '',
	gdpr_show_all_reviews_threecgd int(11) NOT NULL DEFAULT '0',
	gdpr_business_locations_threecgd varchar(255) NOT NULL DEFAULT '',
	tx_gdprreviewsclient_slider_max_reviews_threecgd int(11) NOT NULL DEFAULT '4',
);
